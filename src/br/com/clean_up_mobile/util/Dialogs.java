...
public class Dialogs extends DialogFragment implements OnClickListener {  
  ...
  public static Dialogs newDialog(int id,   
  ...
  // Interface que erá chamada ao clicar no botao  
